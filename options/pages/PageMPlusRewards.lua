...
function ns:InitMPlusRewardsPage()
    ...
    local module = Addon:GetModule("mplus_rewards")
    ...
    enableLabel:SetText("Enable M+ Rewards Module")
    ...
    enableToggle:SetChecked(Addon:IsModuleEnabled("mplus_rewards"))
    enableToggle:SetScript("OnClick", function(self)
        if module and type(module.SetEnabled) == "function" then
            ...
            Addon.db.modules.mplus_rewards.enabled = self:GetChecked() and true or false
        end
        apply()
    end)
        ...
        AddTwoColumnRow(b,
            function(lb)
                lb:Cycle("Module Font",
                    ...
                    function()
                        local media = Addon:GetModuleMediaConfig("mplus_rewards")
                        return media.font
                    end,
                    function(v)
                        local media = Addon:GetModuleMediaConfig("mplus_rewards")
