...
Addon:RegisterModule("shared_media", Module)

local LSM = LibStub and LibStub("LibSharedMedia-3.0", true)
local MEDIA_ROOT = "Interface\\AddOns\\" .. ADDON_NAME .. "\\modules\\shared_media\\"
...
function Module:RegisterSharedMedia()
    if self.mediaRegistered then
        return
    end

    if not LSM then
        Addon:Print("LibSharedMedia-3.0 was not found. Shared media was not registered.")
        return
    end
