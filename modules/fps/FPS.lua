...
Addon:RegisterModule("fps", Module)
...
local function GetBackupDB()
    Addon.db.fps = type(Addon.db.fps) == "table" and Addon.db.fps or {}
    Addon.db.fps.backup = type(Addon.db.fps.backup) == "table" and Addon.db.fps.backup or {}
    return Addon.db.fps.backup
end
